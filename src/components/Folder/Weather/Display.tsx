  ...
  return (
    <div className='w-3/4 bg-stone-800/60 h-full p-5 text-center'>
      ...
      <div className='flex items-center justify-center flex-wrap'>
        <h1 className='font-medium relative after:content-["o"] after:-top-1 after:absolute after:size-9 after:text-white min-w-fit px-4 after:text-[4rem]'>
          <span className='text-[10rem]'>{weather.current.temp_c}</span>
        </h1>
        <div className='ml-10 mt-2 text-2xl space-y-6'>
